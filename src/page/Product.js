...
const Product = ({ translations, currentLang }) => {
    ...
    const productPrice = 5; // Discounted price per unit
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                    ...
                    {/* Price Section */}
                    <div className="text-2xl font-bold text-gray-800 flex items-center space-x-4">
                        <span className="line-through text-red-500">₹ {originalPrice}</span>
                        <span className="text-green-600">₹ {productPrice}</span>
                    </div>
                    <p className="text-sm text-gray-600">Online payment can have a 10% discount.</p>
